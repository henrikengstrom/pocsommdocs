...
(function () {
    ...
    var I18N = {
        ...
        fr: {
            ...
            "imp.kicker": "Importer une carte des vins",
            "imp.h": "Étudiez la carte avant d'y aller",
            "imp.p": "Une belle table en vue ? Importez la carte des vins du restaurant à l'avance et arrivez en connaissant déjà les bonnes affaires.",
            "imp.li1": "Importez un PDF ou des photos, ou collez un lien vers la carte",
            "imp.li2": "Mêmes prix boutique, étiquettes de valeur et notes qu'un scan en direct",
            "imp.li3": "Ajoutez des pages à tout moment — tout fusionne en une seule liste",
            "ask.kicker": "Demandez à PocSomm",
            "ask.liRecipe": "Vous cuisinez ? Collez le lien d'une recette et obtenez des vins adaptés au plat",
        ...
        it: {
            ...
            "imp.kicker": "Importa una carta dei vini",
            "imp.h": "Studia la carta prima di uscire",
            "imp.p": "Una serata speciale in vista? Importa in anticipo la carta dei vini del ristorante e arriva conoscendo già le scelte migliori.",
            "imp.li1": "Carica un PDF o foto, oppure incolla un link alla carta",
            "imp.li2": "Stessi prezzi al dettaglio, etichette di valore e punteggi di una scansione dal vivo",
            "imp.li3": "Aggiungi altre pagine quando vuoi — tutto si unisce in un'unica lista",
            "ask.kicker": "Chiedi a PocSomm",
            "ask.liRecipe": "Cucini a casa? Incolla il link di una ricetta e ottieni vini abbinati al piatto",
        ...
        es: {
            ...
            "imp.kicker": "Importa una carta de vinos",
            "imp.h": "Estudia la carta antes de ir",
            "imp.p": "¿Una cena especial a la vista? Importa la carta de vinos del restaurante con antelación y llega conociendo ya las mejores opciones.",
            "imp.li1": "Sube un PDF o fotos, o pega un enlace a la carta",
            "imp.li2": "Los mismos precios, etiquetas de valor y puntuaciones que un escaneo en vivo",
            "imp.li3": "Añade más páginas cuando quieras — todo se fusiona en una sola lista",
            "ask.kicker": "Pregunta a PocSomm",
            "ask.liRecipe": "¿Cocinas en casa? Pega el enlace de una receta y obtén vinos a la medida del plato",
        ...
        ja: {
            ...
            "imp.kicker": "ワインリストを取り込む",
            "imp.h": "行く前にリストを研究",
            "imp.p": "特別なお店の予定は？レストランのワインリストを事前に取り込めば、おすすめを知った上で到着できます。",
            "imp.li1": "PDFや写真をアップロード、またはリストへのリンクを貼り付け",
            "imp.li2": "その場でのスキャンと同じ価格・お得度ラベル・評価",
            "imp.li3": "ページはいつでも追加可能 — すべて1つのリストに統合",
            "ask.kicker": "PocSommに聞く",
            "ask.liRecipe": "自宅で料理？レシピのリンクを貼るだけで、その料理に合うワインを提案",
            "ask.h": "いつでも頼れるソムリエ",
        ...
        zh: {
            ...
            "hero.androidSoon": "Android 版即将推出",
            ...
            "imp.kicker": "导入酒单",
            "imp.h": "出发前先研究酒单",
            "imp.p": "要去特别的餐厅？提前导入餐厅酒单，到店时已了然于胸。",
            "imp.li1": "上传 PDF 或照片，或粘贴酒单链接",
            "imp.li2": "与现场扫描相同的价格、性价比标签和评分",
            "imp.li3": "随时添加更多页面 — 全部合并为一份酒单",
            "ask.kicker": "问问 PocSomm",
            "ask.liRecipe": "在家做饭？粘贴食谱链接，获取与菜品匹配的葡萄酒",
            "ask.h": "随叫随到的侍酒师",
